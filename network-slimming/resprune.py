...
def test(model):
    ...
    print('\nTest set: Accuracy: {}/{} ({:.4f}%) , Inference time: {:.2f}\n'.format(
        correct, len(test_loader.dataset), 100. * correct / len(test_loader.dataset), inference_time))



    return correct / float(len(test_loader.dataset)), inference_time
